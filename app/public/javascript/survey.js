$(document).ready(function() {
    ...
    var questions = [
        'I cheer for the Michigan Wolverines.',
        'I like to work long hours.',
        'I do not make the best diet decisions.',
        'I believe that golfing is exciting and fulfilling.',
        'I think having a nice yard is the neighborly thing to do.',
        'Drivers who text through green lights should face corporal punishment.',
        'Dogs are better than cats.',
        'Texas BBQ should be a food group.',
        'Calculus, physics and critical thinking classes should be the minimum requirment to be called a college graduate.',
        'Talking politics at work makes you an asshole.'
    ];
